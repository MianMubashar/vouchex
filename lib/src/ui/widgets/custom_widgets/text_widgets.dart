...
Text titleText(String text, {double size = 26,FontWeight fontWeight = FontWeight.w700, TextAlign textAlign = TextAlign.start, Color clr = blackText}){
  return Text(text,style: TextStyle(color: clr,fontSize: size,fontWeight: fontWeight, fontFamily: 'Nunito',), textAlign: textAlign,);
}
Text smallText(String text, {double size = 16, Color clr = greyText,
  FontWeight fontWeight = FontWeight.w400, TextAlign textAlign = TextAlign.start,
